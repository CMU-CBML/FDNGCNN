...
dataset = H5Dataset('../dataset_for_ML/NG_multiple_CNN_restructured_cleaned_11022022.hdf5')
...
def checkpoint(epoch):
    model_out_path = "./checkpoint_3channel_multipleNeuron_BCE/model_epoch_{}.pth".format(epoch)
...
# %%
# model = torch.load('./checkpoint_3channel_multipleNeuron_BCE/model_epoch_100.pth')
# model.eval()
...
dataset = H5Dataset('../dataset_for_ML/NG_multiple_CNN_restructured_11022022.hdf5')
